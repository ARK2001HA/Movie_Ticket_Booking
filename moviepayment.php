...
<section>
	<div class="sidebar">
		...
		<ul class="nav">
			...
			<li class="active"><a href="moviepayment.php"><i class="fa fa-pie-chart"></i> Payments</a></li>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td data-label="Period"><?php echo $result['cardnum'] ?></td>
      <td data-label="Period"><?php echo $result['name'] ?></td>
      <td data-label="Period"><?php echo $result['month'] ?></td>
      <td data-label="Period"><?php echo $result['year'] ?></td>
      <td data-label="Period"><?php echo $result['cvv'] ?></td>
      <td data-label="Period"><?php echo $result['totalpay'] ?></td>

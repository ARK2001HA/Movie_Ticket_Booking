        ...
        <div class="navbar-container">
            ...
            <div class="menu-container">
                <ul class="menu-list">
                    ...
                    <a href="homeaction.php">
                    <li class="menu-list-item">My Bookings</li></a>
                </ul>
            </div>
            <div class="profile-container">
                <div class="profile-text-container">
                    <a class="nav-item nav-link" style="color: red;" href="signup.php"><span class="profile-text">SignUp</span></a>

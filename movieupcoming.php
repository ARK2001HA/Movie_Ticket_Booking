...
$sql= "SELECT * FROM movie_upcoming";
...
<section>
	<div class="sidebar">
		...
		<ul class="nav">
			...
			<li class="active"><a href="movieupcoming.php"><i class="fa fa-database"></i> Upcoming Movies</a></li>
		</ul>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td data-label="Period"><img src="<?php echo $result['images'] ?>" width="100" height="100"></td>  
    </tr>
      <?php
      }
      ?>
